...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a class="menu-link" href="#">Admistrar</a>
                    <ul class="submenu">
                        <li><a href="<?=BASE_URL?>/../src/views/admin/index.php">Sudaderas</a></li>
                        <li><a href="<?=BASE_URL?>/../src/views/admin/tshirts/playeras.php">Playeras</a></li>
                        <li><a href="<?=BASE_URL?>/../src/views/admin/pants/pantalones.php">Pantalones</a></li>
                        <li><a href="<?=BASE_URL?>/../src/views/admin/shirts/camisas.php">Camisas</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
